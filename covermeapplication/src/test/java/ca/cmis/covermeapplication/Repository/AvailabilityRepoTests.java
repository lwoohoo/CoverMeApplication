...
public class AvailabilityRepoTests {
    ...
    @Test
    public void testFindAvailabilityByAccount() {
        //create account
        String name = "Peter Quinley";
        String email = "Peter@yandex.ru";
        String phoneNumber = "902-310-3030";
        ...
        List<Availability> availabilities = availabilityRepository.findAvailabilityByAccount(account);
    
        assertEquals(availabilities.size(), 1);
        assertNotNull(availabilities.get(0));
        assertEquals(availabilities.get(0).getEventID(), availability.getEventID());
